...
sap.ui.define([
	...
	function (Controller) {
		...
		return Controller.extend("jgp.List.controller.ListTypes", {
			onInit: function () {
            ...
            onDeleteSelectedRows: function() {
                ...
                if (selectedItems.length === 0){
                    ...
                    products = products.filter(function(p){
                        return !arrayId.includes(p.Id);      //toma los productos no seleccionados
                    });

                    products = model.setProperty("/Products", products); //actualiza el modelo
            ...
            onDeleteRow: function(oEvent) {
                ...
                var model = this.getView().getModel();
                var products = model.getProperty("/Products");
                products.splice(indexSelectedRow,1);  //desde la posicion indexSelectedRow, elimine 1 registro
                model.refresh();
